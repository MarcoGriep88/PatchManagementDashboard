    ...
    public class ValuesController : ApiController
    {
        ...
        public IEnumerable<DataEntry> Get()
        {
            ...
            else
            {
                ...
                using (SqlConnection connection = new SqlConnection("Data Source=qbb24\\universal;Initial Catalog=lansweeperdb;User ID=lansweeperuser;Password=mVx8489mVx8489_+;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"))
                {
